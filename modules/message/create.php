...
// echo "<br>to==".$to_email;
// echo "<br>sub==".$email_subject;
// echo "<br>meg==".$email_message;
// echo "<br>from==".$from;
...
//friends
$select_user_friend2=$dbObj->customqry("select f.*,u.photo as photo1,u1.photo as photo2,u.first_name,u.last_name,u1.first_name as first_name1,u1.last_name as last_name1 from tbl_friends f left join tbl_users u on f.userid=u.userid  left join tbl_users u1 on f.friendid=u1.userid where ((f.userid='".$_SESSION['csUserId']."' and f.friendid='".$_GET['id1']."') or  (f.userid='".$_GET['id1']."' and f.friendid='".$_SESSION['csUserId']."')) and f.verification='yes' group by f.userid,f.friendid ","");
...
$smarty->display( TEMPLATEDIR . '/modules/messages/create.tpl');
$dbObj->Close();
?>
