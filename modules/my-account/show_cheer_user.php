...
{
$sel_cheer=$dbObj->customqry("select c.*,u.* from tbl_cheers c left join tbl_users u on c.userid=u.userid  where c.activity_id='".$_GET['activityid']."' group by cheer_id","1");
}
...
$smarty->display(TEMPLATEDIR . '/modules/my-account/show_cheer_user.tpl');
$dbObj->Close();
?>