<?php
	...
	$res_user2 = $dbObj->cgs("tbl_users","*","userid",$_SESSION['csUserId'],"","","");
    ...
    <td  width="700" style="background:#f3f3f3; padding:6px;"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td width="687" height="110" align="left" valign="middle" bgcolor="#FFFFFF"><table width="687" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="20">&nbsp;</td>
            <td width="187"><img src="../../pdf/images/logo.jpg" width="187" height="74"></td>
            <td width="258" ><div style="padding:15px 15px; text-align:center";>'.substr(wordwrap($voucherDesc, 40, "<br>\n", true),0,250).'</div></td>
            <td width="195">'.$barcode_image.'</td>
            <td width="26">&nbsp;</td>
          </tr>
        </table></td>
      </tr>
            ...
            <td><table width="675" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="376" valign="top"><table width="376" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    <td width="376" style="font-size:21px; color:#cc0000; font-weight:bold;">Usortd Value: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$dealCurr.' '.$yourPrice.'</td>
                  </tr>
                  <tr>
          ...
          <tr>
            <td width="675" style="border:solid 1px #c8c8c8; background:#f3f3f3;"><table width="675" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="607" align="left" style="font-size:17px; font-weight:bold; color:#485d07;">Voucher Code: '.$couponId.'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Valid from '.$validFrom.' to '.$validTo.'</td>
      ...
      <tr>
   <td width="687" align="center" style="background:#FFFFFF; font-size:13px; padding:6px;">Any questions: Customer Support: 02035100410, weekdays 9am - 6pm , Email us: support@usortd.co.uk</td>
      </tr>
      <tr>
...
$pdf_newname="usortd-".$payunique['coupon_id'].'.pdf';
