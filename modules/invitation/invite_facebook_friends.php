...
//    'secret' => '2c3186a410eb846ede811ef86825b448',
    'appId' => '101047238433',
    'secret' => 'ed6e9afd784b0eeb10d67dd3379bbcb2',
    'cookie' => true
));
...
if(isset($_POST['submit'])){
    ...
    if($_POST['sfriends']!="")
    {	
//        if($_SESSION['fb_101047238433_access_token']!="" && $_SESSION['fb_101047238433_user_id']!="")
        //{
            //$uid = $_SESSION['fb_101047238433_user_id'];
            //$access_token = $_SESSION['fb_101047238433_access_token'];
            //if($uid){                    
                try {
                    ...
                    $post =  array(
                        ...
                        'link'         => "testwww.offersnpals.com",
                        'picture'      => 'http://testwww.offersnpals.com/templates/default/images/offernpals-logo.png',
                        'description'  => $d,
                        'actions'      => array(array('name' => "offersnpals",
                        'link' => "http://testwww.offersnpals.com/"))
                    );
...
<form name="facebook_friends" id="facebook_friends" action="" method="POST">
    <div id="facebook" style="<?php if (is_array($friends)) {?>height:470px;<?php } ?>width:450px;">
        ...
        ?>
            <tr>
                <td style="width:25px;padding-bottom:10px;"></td>
                <TD colspan="4" style="padding-bottom:10px;padding-top:10px;font: 12px/16px Arial,Helvetica,sans-serif;color: #656565;"><input type="checkbox" name="checkall" id="checkall">&nbsp;&nbsp;Select All</td>
            </tr>
        <?php 
        } 
