...
// if($_SESSION['profilecity']=="")
// {
// @header("Location:".SITEROOT."/profileinfo");
// }

if($_SESSION['profileemail']=="")
{
@header("Location:".SITEROOT."/profileemail");
}
...
//if(($_POST['right_now_deal']!="" || $_POST['usual_deal']!="") && $_POST['chk_category']!="")
if($_POST['chk_category']!="")
{
	if($_POST['right_now_deal']!="" && $_POST['usual_deal']!="")
	{
	$_SESSION['profile_intrested_in']=$_POST['right_now_deal'].",".$_POST['usual_deal'];
	}
	elseif($_POST['usual_deal']!="")
	{
	$_SESSION['profile_intrested_in']=$_POST['usual_deal'];
	}
	elseif($_POST['right_now_deal']!="")
	{
	$_SESSION['profile_intrested_in']=$_POST['right_now_deal'];
	}
...
$smarty->display(TEMPLATEDIR.'/modules/registration/profile_info_step2.tpl');
