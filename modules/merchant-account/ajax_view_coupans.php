...
$rs=$dbObj->customqry("select dp.uniqueid,dp.coupon_id,d.deal_title from tbl_deal_payment_unique dp,tbl_deals d where dp.deal_id=d.deal_unique_id and dp.deal_id=".$_POST['deal_id']." and d.merchant_id=".$_SESSION['csUserId'],"");
$i=0;
...
$count_voucher=@mysql_num_rows($rs);
$smarty->assign("count_voucher",$count_voucher);
$smarty->display(TEMPLATEDIR . '/modules/merchant-account/ajax_view_coupans.tpl');
$dbObj->Close();
?>