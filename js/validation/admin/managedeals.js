	...
	{
		ajax.sendrequest("GET", SITEROOT+"/admin/globalsetting/deal/get_city.php", {val:val}, '', 'replace');
	}
	function getMerchants(val)
	{
		ajax.sendrequest("GET", SITEROOT+"/admin/globalsettings/deal/get_merchant.php", {val:val}, '', 'replace');
	}
