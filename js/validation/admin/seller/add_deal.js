...
function setCurrency(objVal)
{
	...
	if(objVal == "pound")
	{
		$('#sub_delivery_cost').val($('#sub_delivery_cost_pound').val());
	}else if(objVal == "euro")
	{
		$('#sub_delivery_cost').val($('#sub_delivery_cost_euro').val());
	}else if(objVal == "dollar")
	{
		$('#sub_delivery_cost').val($('#sub_delivery_cost_dollar').val());
	}
}
...
function fillStates(Obj)
{
	...
	var url = SITEROOT+"/admin/seller/deal/show_states.php";
	url=url+"?cnid="+val;
...
function fillCities(Obj)
{
	...
	var url = SITEROOT+"/admin/seller/deal/show_cities.php";
	url=url+"?stid="+val;
