...
function DHTMLgoodies_formTooltip()
{
	...
	this.imagePath = SITEROOT+'/templates/default/images/';
	this.arrowImageFile = 'leftarrow.png';
	this.arrowImageFileRight = 'green-arrow-(1).gif';
	this.tooltipWidth = 200;
	this.tooltipBgColor = '#9BBB2B';
...
// 		alert(inputs.length);
		...
		document.write("<b>arr["+i+"] is </b>=>"+formElements[i]+"<br>");
			}
	*/
	...
	__createTooltip : function()
	{
		...
		this.tooltipContentDiv.style.textAlign ='center';
