...
#------------Check For access----------#
if(!(in_array("45", $arr_modules_permit)))
{
                        	...
                        	<div class="griddealbg">
                            	<div class="ovfl-hidden">
                                	<div class="imgsec fl">
                                        ...
                                        <tr>
                                          <td align="center"><span><a target="_blank" href='.$linkurl11.'><img src='.SITEROOT.'/uploads/product/thumb122X145/'.$image[0].' alt="img" /></a><span></td>
                                        </tr>
                                      </table>
...
$i++;
        ...
        if($strsplit !='')
        {
	  // echo "<pre>";print_r($strsplit);echo "</pre>";exit;
		...
		$u_email=base64_encode($strsplit[$m]);
...
// 		$email_message  = str_replace("[[img]]",$image,$email_message);
	    ...
	    $_SESSION['msg_news']="<span>Please enter email address</span>";
...
$smarty->display(TEMPLATEDIR.'/admin/globalsettings/message-center/send_message.tpl');
$dbObj->close();	
?>
