<?php
	...
	$tbl = "tbl_deal as p";
	$sf = "*";
        $cnd = "p.deal_status = 1 and p.news_subscribe=1 and (p.start_date <= '$date' and p.end_date >= '$date')";
	...
	$smarty->display(TEMPLATEDIR.'/admin/globalsettings/deal/newsletter-promotion-list.tpl');
?>
