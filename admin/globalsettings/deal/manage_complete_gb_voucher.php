...
#------------Check For access----------#
if(!(in_array("13", $arr_modules_permit)))
{
...
#-----------Delete Articles--------------#
	...
	if($search)
		$firstlink = "manage_complete_gb_voucher.php?search=" . $_GET['search'];
	else
		$firstlink = "manage_complete_gb_voucher.php?dealstatus=".$_GET['dealstatus']."&dealtype=".$_GET['dealtype']."&seller=".$_GET['seller'];
	$seperator = '&page=';
	$baselink = $firstlink;
   ...
   #----------Success message=--------------#
	...
	$smarty->display(TEMPLATEDIR.'/admin/globalsettings/deal/manage_complete_gb_voucher.tpl');
?>
