...
#-----------------Get seller Types--------------------#
   ...
   $sf = "p.*";
   $cnd = " p.admin_approve = 'yes' and p.admin_review = '1' and p.deal_status = '1' and (p.start_date > '$date')";
...
//  $res = $dbObj->gj($tbl,$sf,$cnd,"deal_unique_id","","DESC",$l, "");
   ...
   $smarty->display(TEMPLATEDIR.'/admin/globalsettings/deal/upcoming_deal.tpl'); 
?>
