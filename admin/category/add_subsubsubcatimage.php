...
if($_POST["Save"])
{
	...
	header("location:". SITEROOT . "/admin/category/subsubsubcatimage.php?cat_id=".$_GET['cat_id']);exit;
...
$smarty->display(TEMPLATEDIR . '/admin/category/add_subsubsubcatimage.tpl');
$dbObj->Close();
?>
