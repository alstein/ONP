...
if($_POST["Save"])
{
	...
	header("location:". SITEROOT . "/admin/category/subsubsubsubcatimage.php?cat_id=".$_GET['cat_id']);exit;
...
$smarty->display(TEMPLATEDIR . '/admin/category/add_subsubsubsubcatimage.tpl');
$dbObj->Close();
?>
