...
if(isset($_POST['task']) && $_POST['task'] == 'save')
{
	...
	if($_GET['id'] != "")
	{
	    ...
	    $s=$msobj->showmessage(249);
	    $_SESSION['msg']="<span class='".$s['msgtype']."'>".$s['msgtext']."</span>";
	}
	header("location:".SITEROOT."/admin/category/subsubsubcat.php?cat_id={$_GET['cat_id']}");
	exit;
}
...
$smarty->display(TEMPLATEDIR . '/admin/category/add_subsubsubcat.tpl');
$dbObj->Close();
?>