...
$cnd="u.usertypeid=3 and u.userid = ".$_SESSION['duAdmId']." ";
...
if($total_pages > 1){
	...
	$firstlink = "login-log.php?sortby=".$_GET['sortby']."&sorttype=".$_GET['sorttype'];

	else
	$firstlink = "login-log.php?";
	$seperator = '&page=';
	$baselink  = $firstlink; 
...
$smarty->display(TEMPLATEDIR . '/admin/seller/login-log.tpl');
$dbObj->Close();
?>