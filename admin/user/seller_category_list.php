		 ...
		 if($_GET['view'] == 'excel')
                 {
                    ...
                    $out .= '"'.$fullname.'","'.$row['email'].'","'.$row['city'].'","'.$row['country_name'].'","'.$row['postalcode'].'","'.$address.'","'.$row['contact_detail'].'","'.$row['about_us'].'","'.$row['category'].'","'.$row['subcategory'].'","'.$row['specility'].'","'.$row['business_name'].'","'.$row['business_webURL'].'","'.date("d-m-Y",strtotime($row['signup_date'])).'","'.$date.'","'.$users[$i]['cost_per_success_deal'].'"';
                    $out .= "\n";
                    #----code end---#
                }
            $i++;
...
$smarty->display(TEMPLATEDIR . '/admin/user/seller_category_list.tpl');
$dbObj->Close();
?>
