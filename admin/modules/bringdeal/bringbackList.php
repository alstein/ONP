...
$selectF="d.title,d.deal_unique_id,count(*) as total";
$tablename="tbl_bring_back as b,tbl_deal as d";
$conition="b.deal_id=d.deal_unique_id";
$res=$dbObj->gj($tablename, $selectF, $conition, "", "b.deal_id", "", $l, "");
...
/*-----------------------Pagination Part2--------------------*/
$rs1 =$dbObj->gj($tablename, $selectF, $conition, "", "b.deal_id", "", "", "");
...
if($total_pages > 1)
{
    ...
    if($_GET['searchuser']!='')
    {
	    $firstlink = "bringbackList.php?searchuser=".$_GET['searchuser'];
	    $seperator = '&page=';
    }
    else 
    {
	  $firstlink = "bringbackList.php";
	  $seperator = '?page=';
    }
    $baselink  = $firstlink;
...
$smarty->display(TEMPLATEDIR . '/admin/modules/bringdeal/bringbackList.tpl');
