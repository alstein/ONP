...
//print_r($deal_id);
 if($_POST['action'])
   ...
   #----------------------------------------#
	...
	$res = $dbObj->customqry("SELECT r.*,u.fullname,u.business_name,u1.fullname as fullname1 FROM tbl_rating as r LEFT JOIN tbl_users as u ON r.merchant_id=u.userid left join tbl_users u1 on r.user_id=u1.userid LIMIT ".$l, "");
  ...
  $res = $dbObj->customqry("SELECT r.*,u.fullname,u1.fullname as fullname1 FROM tbl_rating as r LEFT JOIN tbl_users as u ON r.merchant_id=u.userid left join tbl_users u1 on r.user_id=u1.userid LIMIT ".$l, "");
