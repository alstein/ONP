...
$siteroot = SITEROOT;
//echo "hello";
$str ='<select class="textbox fl" name="subsubcategory" id="subsubcategory"  onchange="javascript: getsubsubsubcat(this.value);"  >'."<option value=''>--Select Sub Sub-Category--</option>";
