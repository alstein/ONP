                ...
                <div class="signinbox ovfl-hidden">
                    ...
                    <div class="signinbox2">
                        <ul class="sinninformbx reset">
                            ...
                            <li> 
                                <label>&nbsp;</label>
                                <div class="fl westspace-6 padnorth-1">
                                    <a href="javascript:void(0)" class="loc_busines fl"><span><input class="loc_busines fl" type="submit" name="submit_login" id="submit_login" value="Log In"></span></a>
                                </div>
                            </li>
                        </ul>
                    </div>
