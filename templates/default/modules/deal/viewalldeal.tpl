        ...
        <div class="deal-slide ">
          ...
          <div class="deal-bg">
            ...
            <div class="deal-user-img"> 
					<a href="{$siteroot}/buy/{$all_deals[i].deal_unique_id}/"><img src="{if $all_deals[i].deal_image}{$siteroot}/uploads/deal/{$all_deals[i].deal_image}{else}{$siteroot}/templates/default/images/deal-image.png {/if}" title="" alt="" width="281" height="292" /></a>
			</div>
...
{/section}
	...
	<ul class="reset"> 	<li style="text-align:right">{$pgnation}</li></ul>
  <!-- Maincontent ends -->
</div>
</div>
{include file=$footer}