...
<!-- Maincontent starts -->
<form name="frmCreateDeal" id="frmCreateDeal" method="POST" enctype="multipart/form-data">
    <div id="maincont">
            ...
            <div class="deal-own-form">
                        ...
                        <li>
                            ...
                            <div class="fl">
                                ...
                                <div class="fr" style="margin-top:-6px; margin-left:10px">
                                    <ul class="reset icn-link" style="padding:0px">
                                        <li>
                                            <a href="#" class="icn-link01 ">What's it?</a>
                                            <div class="tooltip">
                                                <span class="arrow">&nbsp;</span>
                                                <div class="top01"><div></div></div>
                                                <div class="mid" style="padding-bottom:5px">Write some key points on the offer deal.</div>
                                                <div class="bot01"><div></div></div>
                                            </div>
                                        </li>
                                    </ul>
                ...
                <div class="deal-own-form-mid">
                    <form id="checkbox">
                        <ul class="reset deal-form">
                            <li>
                                <label>Maximum numbers that can be bought:</label>
                                <div class="fl textbox">
                            ...
                            <li>
                                ...
                                <div class="category-bg  fl">
                                    <select name="address" id="address" style="width:178px;" class="select" >
                                        ...
                                        {if $address.address1 neq ''}
                                        <option value="{$address.address1}" {if $smarty.session.valid_at_address eq $address.address1 } selected="selected" {/if}>{$address.address1}</option>
                                        {/if}
                                        {if $address.address2 neq ''}
                                        <option value="{$address.address2}" {if $smarty.session.valid_at_address eq $address.address2 } selected="selected" {/if}>{$address.address2}</option>
                                        {/if}
                                        {if $address.address3 neq ''}
                                        <option value="{$address.address3}" {if $smarty.session.valid_at_address eq $address.address3 } selected="selected" {/if}>{$address.address3}</option>
                                        {/if}
                                        {if $address.address4 neq ''}
                                        <option value="{$address.address4}" {if $smarty.session.valid_at_address eq $address.address4 } selected="selected" {/if}>{$address.address4}</option>
                                        {/if}
                                        {if $address.address5 neq ''}
                                        <option value="{$address.address5}" {if $smarty.session.valid_at_address eq $address.address5 } selected="selected" {/if}>{$address.address5}</option>
                                        {/if}
                                    </select>
                                </div>
                                <div class="clr"></div>
                            ...
                            <li>
                                ...
                                I would ship. Cash on Delivery    
                                <input type="radio" id="shipping-add" name="shipping-addr" value="1" /> 
                                <span style="padding-left:20px;"></span>
                                Customer would get product/service at my outlet     
                                <input type="radio" id="no-shipping-add" name="shipping-addr" value="0" /><br/><br/>
                            </li>
                            <li>
