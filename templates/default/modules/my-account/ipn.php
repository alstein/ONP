...
if($pay_row['paypal_account']=="s.rakesh@agiletechnosys.com")
{
...
//insert into tbl_activity
	...
	//send mail to customer
					...
					$msg=ucfirst($fullname1)." bought a "."<div><a href=$link_deal>".ucfirst($dealname)."</a></div>";
					$insert_thinking=$dbObj->customqry("insert into tbl_activity(msg,vault_t,vault,timestamp,wall,uid,fid,parent_id,deal_id)values('".$msg."','buy_deal','".$res_offer_deal['deal_image']."',Now(),'0','".$res_user['userid']."','".$res_merchant['userid']."','','') ","");
