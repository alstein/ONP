...
<!--<iframe src="{$siteroot}/GoogleMapAPI-2.5/map.php?location={$maplocation}&width=1300&height=480"  width="1300px" height="480px"  frameborder="0" scrolling="no" marginheight="0" marginwidth="0" style="margin-left:1px"></iframe>-->
</div>
</body>
</html>