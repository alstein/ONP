                ...
                <div class="maincont-inner-mid fl">
                                ...
                                <div class="basic-info">
                                    ...
                                    <ul class="reset basic-form ">
                                        ...
                                        <li>
                                            ...
                                            <div class="fl basic-txt">
                                                <p>
                                                    {$business_start_date1}AM to {$business_end_date1}PM (Monday to Friday)<br  />                                                   {$business_start_date2}AM to {$business_end_date2}PM (Saturday &amp; Sunday)
                                                </p>
                                            </div>
                                            <div class="clr"></div>
                                        </li>
                    ...
                    <form method="post" name="sleeker" id="sleeker" enctype="multipart/form-data">
                        <div class="whats-in-mind" id="div_share" style="display:none;padding:33px 14px;width:537px;">
                            <input  class="whats-in-mind-textbox"  type="text" name="txt_thinking" id="txt_thinking" value="What you have been thinking?"  onBlur="if(this.value=='')this.value='What you have been thinking?'" style=" background: none repeat scroll 0 0 #FFFFFF;border: 1px solid #DDDDDD;margin: 10px auto;padding: 7px 10px;width: 370px;"   onClick="if(this.value=='What you have been thinking?')this.value=''"/> 
                            <input type="text" name="txt_link" id="txt_link"  class="whats-in-mind-textbox" value="Enter your link"  onClick="if(this.value=='Enter your link')this.value=''"  onBlur="if(this.value=='')this.value='Enter your link'"  style=" background: none repeat scroll 0 0 #FFFFFF;border: 1px solid #DDDDDD;margin: 10px auto;padding: 7px 10px;width: 330px;display:none;"/>
                    ...
                    <form method="post" name="sleeker" id="sleeker" enctype="multipart/form-data">
                        <div class="whats-in-mind" id="div_share" style="display:none;padding:33px 14px;">
                            ...
                            <input type="text" name="txt_link" id="txt_link"  style=" background: none repeat scroll 0 0 #FFFFFF;border: 1px solid #DDDDDD;margin: 10px auto;padding: 7px 10px;width: 370px;display:none;" class="whats-in-mind-textbox" value="Enter your link"  onBlur="if(this.value=='')this.value='Enter your link'" onClick="if(this.value=='Enter your link')this.value=''" onfocus="if(this.value=='Enter your link')this.value=''"/>
                            <div class="fr"> 
                                <span class="share-btn-lft">
                                    <span class="share-btn-rgt">
                                ...
                                <span class="share-btn-lft" style="margin-left:5px">
                                    <span class="share-btn-rgt">
