...
<!--<div class="breadcrumb"><a href="{$siteroot}/admin/index.php">Home</a> &gt; Manage Upcoming Deals
</div><br/>-->
	...
	<section class="grybg">
		<div class="pagehead">
			<div class="grpcol">
                ...
                <a href="{$siteroot}/admin/seller/deal/upcoming_deal.php"  class="active">Upcoming Deals ({$deal_notice_info_seller.tot_upcom})</a> &nbsp;&nbsp;|&nbsp;&nbsp; 
		...
		<div class="innerdesc">
        <h3 class="pagehead2 fl">Manage Upcoming Deals</h3>
<div >
    ...
    <table cellpadding="2" cellspacing="0" width="100%" style="vertical-align:top;">
	  <tr>
		...
		<table cellpadding="6" cellspacing="2" border="0" width="100%" class="listtable">
			...
			<td width="10%" align="left" valign="top">Added By</td>
			...
			<img src="{$siteroot}/templates/default/images/icons/application_edit.png" align="absmiddle" />&nbsp;<a href="{$siteroot}/admin/seller/deal/edit_product.php?back=up&id={$deal[i].deal_unique_id}"><strong>Edit</strong></a>
			<!--{*
			<br>
