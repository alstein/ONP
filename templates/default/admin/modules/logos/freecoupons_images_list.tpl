...
<script type="text/javascript" src="{$siteroot}/js/validation/admin/add_freecoupons_list.js"></script>
{literal}
...
<div class="breadcrumb"><a href="{$siteroot}/admin/index.php">Home</a> &gt; Manage Free Coupons Images List</div><br/>
<div class="holdthisTop">
	<div>
	  <div class="fl width50">
		  <h3>{$sitetitle} Manage Free Coupons Images List</h3>
	  </div>
          <div class="clr">&nbsp;</div> <span  class="fr"><img src="{$siteimg}/icons/add.png" align="absmiddle" /><a href="add_freecoupons_images.php">Add New Image</a></span>
	...
	<table cellspacing="2" cellpadding="3" class="listtable" width="100%">	
		...
		<tr class="grayback" id="tr_{$smarty.section.i.iteration}">
		  ...
		  <td valign="middle">
		   <img src="{$siteroot}/uploads/freecoupon_image/{$list[i].image}" title="{$list[i].title}" align="middle" style="float:left;" width="35" height="36" /> </td>
		  ...
		  <td valign="middle">
		   <div>
                      <img src="{$siteroot}/templates/default/images/icons/application_edit.png" align="absmiddle" />
                        <a href="add_freecoupons_images.php?edit_id={$list[i].id}" title="Edit">
