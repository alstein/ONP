...
{if $smarty.get.edit_id}
    <script type="text/javascript" src="{$siteroot}/js/validation/admin/edit_travelbar_image.js"></script>
{else}
    <script type="text/javascript" src="{$siteroot}/js/validation/admin/add_travelbar_image.js"></script>
{/if}
{include file=$header2}

<div class="breadcrumb"><a href="{$siteroot}/admin/index.php">Home</a> &gt;<a href="{$siteroot}/admin/modules/logos/travelbar_images_list.php"> Manage Travelbar Images List</a> &gt;
{if $smarty.get.edit_id} Edit Manage Travelbar Images{else} Add Manage Travelbar Images{/if}</div><br/>

<div class="holdthisTop">
	<div>
	  <div class="fl width50">
		  <h3>{$sitetitle}  Manage Travelbar Images</h3>
	  </div>
          <div class="clr">&nbsp;</div>
           ...
           <div> Please enter upto 255 characters.</div></td> 
             ...
             <tr> 
              ...
              <td align="left" width="40%">
                ...
                {if $image_logo}
               <br>
                <div> <img src="{$siteroot}/uploads/travelbar_image/{$image_logo}" title="Active" align="middle" style="float:left;" width="35" height="36"  /></div>{/if}
              </td>
             </tr>
             <tr>
      ...
      <div style="width:34%"> 
         ...
         {if $id neq ""}
                 ...
                 {else}
                  ...
                  {/if}
                 <input type="button" name="Cancel" id="Cancel" value="Cancel" onclick="javascript: location='travelbar_images_list.php'" 
                 class="but_new fl"/>
      </div>
      </div>
      </td>
