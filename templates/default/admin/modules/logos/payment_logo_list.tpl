...
<script type="text/javascript" src="{$siteroot}/js/validation/admin/manage_logo_list.js"></script>
{literal}
...
<div class="breadcrumb"><a href="{$siteroot}/admin/index.php">Home</a> &gt; Manage Payment Logos</div><br/>
<div class="holdthisTop">
	<div>
	  <div class="fl width50">
		  <h3>{$sitetitle} Manage Payment Logos</h3>
	  </div>
          <div class="clr">&nbsp;</div> <span  class="fr"><img src="{$siteimg}/icons/add.png" align="absmiddle" /><a href="add_paymentlogo.php">Add New Logo</a></span>
	...
	<table cellspacing="2" cellpadding="3" class="listtable" width="100%">	
		...
		<td width="1%" align="center"><input type="checkbox" id="checkall" name="checkall"/></td>
		  <td width="*%" align="left">Logo Title</td>
		...
		<tr class="grayback" id="tr_{$smarty.section.i.iteration}">
		  ...
		  <td valign="middle">
		   <img src="{$siteroot}/uploads/logos/{$list[i].logo_image}" title="{$list[i].title}" align="middle" style="float:left;" width="51" height="33" /> </td>
		  ...
		  <td valign="middle">Order
		   ...
		   <div>
                      <img src="{$siteroot}/templates/default/images/icons/application_edit.png" align="absmiddle" />
                        <a href="add_paymentlogo.php?edit_id={$list[i].id}" title="Edit">
