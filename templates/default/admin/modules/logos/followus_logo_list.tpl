...
<script type="text/javascript" src="{$siteroot}/js/validation/admin/followus_logo_list.js"></script>
{literal}
<script lalanguage="JavaScript" type="text/javascript">
function validate_number(val,id)
{
...
<div class="breadcrumb"><a href="{$siteroot}/admin/index.php">Home</a> &gt; Manage Follow us Logos</div><br/>
<div class="holdthisTop">
	<div>
	  <div class="fl width50">
		  <h3>{$sitetitle} Manage Follow us Logos</h3>
	  </div>
          <div class="clr">&nbsp;</div> <span  class="fr"><img src="{$siteimg}/icons/add.png" align="absmiddle" /><a href="add_followsus.php">Add New Logo</a></span>
	...
	<table cellspacing="2" cellpadding="3" class="listtable" width="100%">	
		...
		<td width="1%" align="center"><input type="checkbox" id="checkall" name="checkall"/></td>
		  <td width="20%" align="left">Logo Title</td>
		  <td width="10%" align="left">Logo Image</td>
		...
		<tr class="grayback" id="tr_{$smarty.section.i.iteration}">
		  ...
		  <td valign="middle">
		   <img src="{$siteroot}/uploads/logos/{$list[i].logo_image}" title="{$list[i].title}" align="middle" style="float:left;" width="35" height="36" /> </td>
		   <td valign="middle">{$list[i].link}</td>
		  <td valign="middle">Order
                    <input type="text" size="2" name="{$list[i].id}" id="{$list[i].id}" value="{$list[i].sort_no}" onblur="javascript:validate_number(this.value,{$list[i].id});" />
                 </td>		 	 
		 	 
		  <td valign="middle">
		   <div>
                      <img src="{$siteroot}/templates/default/images/icons/application_edit.png" align="absmiddle" />
                        <a href="add_followsus.php?edit_id={$list[i].id}" title="Edit">
