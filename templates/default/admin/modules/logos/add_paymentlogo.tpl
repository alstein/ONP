...
{if $smarty.get.edit_id}
    <script type="text/javascript" src="{$siteroot}/js/validation/admin/edit_paymentlogo.js"></script>
{else}
    <script type="text/javascript" src="{$siteroot}/js/validation/admin/add_paymentlogo.js"></script>
{/if}
{literal}
...
<div class="breadcrumb"><a href="{$siteroot}/admin/index.php">Home</a> &gt;<a href="{$siteroot}/admin/modules/logos/payment_logo_list.php"> Manage Payment Logos</a> &gt;
{if $smarty.get.edit_id} Edit Manage Payment Logos{else} Add Manage Payment Logos{/if}</div><br/>

<div class="holdthisTop">
	<div>
	  <div class="fl width50">
		  <h3>{$sitetitle}   Manage Payment Logos</h3>
	  </div>
          <div class="clr">&nbsp;</div>
           ...
           <div> Please enter upto 255 characters.</div></td> 
             ...
             <tr> 
              ...
              <td align="left" width="40%">
                <input type="file" name="image" id="image" value="{$video_file}"  contenteditable="false"/>&nbsp;&nbsp;<br/>(Note: Please upload image with 51*33 [w*h]) [Image should be .jpg,.gif,.png file. ]
                {if $smarty.get.edit_id}
               <br>
                <div> <img src="{$siteroot}/uploads/logos/{$image_logo}" title="Active" align="middle" style="float:left;" width="51" height="33" /></div>{/if}
              </td>
             </tr>
         <tr>
    ...
    <tr>
      ...
      <div style="width:50%"> 
         ...
         {if $id neq ""}
                 ...
                 {else}
                   <div id="buttonregister" style="margin-right:5px"><input type="submit" name="Save" id="Save" value="Save" class="but_new fl"/></div>
                  {/if}
                 <input type="button" name="Cancel" id="Cancel" value="Cancel" onclick="javascript: location='payment_logo_list.php'" 
                 class="but_new fl"/>
