...
<div class="breadcrumb"><a href="{$siteroot}/admin/index.php">Home</a> &gt; Manage Active Aggregate Deals

</div><br/>

<div class="holdthisTop">
 <h3 align="left"><b>Manage Active Aggregate Deals</b></h3>
 <div>
<form name="frmSearch" id="frmSearch" method="GET">
    <table  align="right" cellpadding="0" cellspacing="0" border="0" style="margin-right:80px" class="fr">
...
<br />
    ...
    <table cellpadding="2" cellspacing="0" width="100%" style="vertical-align:top;">
	  <tr><TD colspan="12"><img align="top" src="{$siteroot}/templates/default/images/icons/excel.gif">&nbsp;<a href="{$siteroot}/admin/modules/affiliate-marchant/deal/manage_deal.php?view=excel&iMerchantId={$smarty.get.iMerchantId}"><strong>Deal Report</strong></a></TD></tr>
	  <tr>
		...
		<table cellpadding="6" cellspacing="2" border="0" width="100%" class="listtable">
			...
			|<br>--><img align="top" src="{$siteroot}/templates/default/images/icons/excel.gif">&nbsp;<a href="{$siteroot}/admin/modules/affiliate-marchant/deal/manage_deal.php?view=excel&exel_id={$deal[i].deal_unique_id}"><strong>Deal Report</strong></a>&nbsp;|&nbsp;<br>
			<img align="top" src="{$siteroot}/templates/default/images/icons/film.png">&nbsp;<a href="{$siteroot}/admin/modules/affiliate-marchant/deal/view_deal.php?id={$deal[i].deal_unique_id}&back=active"><strong>View Deal</strong></a>&nbsp;|&nbsp;<br>&nbsp;
			{if $deal[i].featured}
			<a href="{$siteroot}/admin/modules/affiliate-marchant/deal/manage_deal.php?act=setUnFeatured&id={$deal[i].deal_unique_id}"><strong>Set Unfeatured</strong></a>
			{else}
			<a href="{$siteroot}/admin/modules/affiliate-marchant/deal/manage_deal.php?act=setFeatured&id={$deal[i].deal_unique_id}"><strong>Set Featured</strong></a>
			{/if}
			</td>
		    </tr>
		    {sectionelse}
