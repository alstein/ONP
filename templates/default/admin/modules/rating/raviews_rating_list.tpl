...
<div class="breadcrumb"><a href="{$siteroot}/admin/index.php">Home</a> <a href="{$siteroot}/admin/modules/rating/raviews_rating_deals_list.php"> &gt; Review And Rating Deals List</a> &gt; Review And Rating List 
</div>
<br/>
    <div class="holdthisTop">
	<div>
                <div class="fl width50">
                        <h3>{$sitetitle} Review And Rating List<br/> <br/>Deal Name:{$deal_name|html_entity_decode}</h3>
                </div>
                <div class="clr">&nbsp;</div>
  	</div>
        <div class="clr">&nbsp; </div>
