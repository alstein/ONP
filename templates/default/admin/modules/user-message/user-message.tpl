...
<div class="holdthisTop">
  <h3 class="fl">Manage User Messages</h3>
  ...
  <table width="100%"  align="center" cellpadding="2" cellspacing="2" border="0">
	...
	<table width="100%"  border="0" cellpadding="10" cellspacing="2" class="listtable">
	    <tr class="headbg">
	      ...
	      <td width="12%" align="left" valign="top">Posted Date</td>	
	  ...
	  {section name=i loop=$msg_info}
	    ...
	    <td align="left" valign="top" >
              <img src="{$siteroot}/templates/default/images/icons/film.png" align="absmiddle" /><a href=" {$siteroot}/admin/modules/user-message/view-user-message.php?id={$msg_info[i].id}"><strong>View</strong>&nbsp;</a>
	      <img src="{$siteroot}/templates/default/images/icons/film.png" align="absmiddle" /><a href=" {$siteroot}/admin/modules/user-message/compose.php?id={$msg_info[i].id}"><strong>Reply</strong></a>
            </td>			
	  </tr>
	  {sectionelse}
