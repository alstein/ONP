...
<div class="breadcrumb">
    <a href="{$siteroot}/admin/modules/user-message/user-message.php">Manage User Messages</a> &nbsp;&gt;&nbsp;View User Message Details
</div><br/>

<h3> &nbsp;View User Message Details</h3>

{if $msg}<div align="center">{$msg}</div>{/if}

<div class="holdthisTop">
  <div style="margin-left:94%;"><a href="{$siteroot}/admin/modules/user-message/user-message.php"><b>Back</b></a></div>
