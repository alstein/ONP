...
<div class="holdthisTop">
  <form name="frmSearch" action="" method="get">
    <table width="100%" cellspacing="0" cellpadding="0" border="0">
      <tr>
		<TD width="20%"><div align="left"><img src="{$siteroot}/templates/default/images/icons/add.png" align="absmiddle" /> <a href=" {$siteroot}/admin/modules/badword/addbadword.php">Add Word</a></div></TD>
    ...
    <td  colspan="2"><form name="frmAction" id="frmAction" method="post" action="">
        <table cellpadding="6" cellspacing="2" align="center" width="100%" border="0" class="listtable">
         ...
         <td width="1%" align="center"><input type="checkbox" id="checkall" /></td>
            ...
            <td width="70%" align="left" valign="top">Word</td>
		...
		<tr class="grayback" id="tr_{$user[i].id}">
			 <td><input type="checkbox" value="{$user[i].id}" name="id[]"/></td>
				...
				<img src="{$siteimg}/icons/{if $user[i].status eq 'Inactive'}award_star_silver_1.png{else}award_star_silver_2.png{/if}" align="absmiddle" />&nbsp;&nbsp;
				{$user[i].bad_word}
			 </td>
