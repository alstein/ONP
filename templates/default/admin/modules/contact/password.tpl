...
<script type="text/javascript" src="{$siteroot}/js/validation/admin/validate_password.js"></script>
...
<div class="holdthisTop">
	<div>
	  <div class="fl width50">
		  <h3>Password for beta Testing</h3>
	  </div>
          <div class="clr">&nbsp;</div>
    ...
    <form name="home_form" action="" id="home_form" method="post" enctype="multipart/form-data">
       <table width="100%" border="0" cellspacing="2" cellpadding="6" class="conttableDkBg conttable">
        <tr> 
           <td width="20%" align="right" ><span style="color:red;">*</span>Password:</td> 
           <td align="left" width="40%"><input type="text" name="password" id="password" value="{$password}"   style="width:268px;" maxlength="255"/>
        </tr>
        <tr>
          <td>&nbsp;</td>
         <td align="left">
