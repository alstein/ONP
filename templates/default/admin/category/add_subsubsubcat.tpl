...
<div class="holdthisTop">
	...
	<input type="hidden" value="{$result.id}" name="subcaatid" id="subcaatid">
        <table width="100%" border="0" cellspacing="2" cellpadding="1">
            <tr>
                <td colspan="2" align="right"><a href="{$siteroot}/admin/category/subsubsubcat.php?cat_id={$smarty.get.cat_id}">Back</a></td>
            </tr>
            <tr>
            ...
            <tr>
		      ...
		      <input type="button" name="Cancel" value="Cancel"  onclick="javascript: location='{$siteroot}/admin/category/subsubsubcat.php?cat_id={$smarty.get.cat_id}'" /></td>
            </tr>
	  </table>
      </form>
    </div>
