...
<div class="breadcrumb"><a href="{$siteroot}/admin/index.php">Home</a> &gt; <a href="{$siteroot}/admin/category/category_list.php">Main Categories</a> &gt; <a href="{$siteroot}/admin/category/subcatimage.php?cat_id={$smarty.get.cat_id}">Image List</a> &gt; {if $smarty.get.edit_id eq ''}Add{else}Edit{/if} Image</div><br />
      ...
      <div style="width:34%"> 
         ...
         {if $id neq ""}
                 ...
                 {else}
                  ...
                  {/if}
<!--                 <input type="button" name="Cancel" id="Cancel" value="Cancel" onclick="javascript: window.history.back();-->
		<input type="button" name="Cancel" id="Cancel" value="Cancel" onclick="javascript: window.history.back(-2);" class="but_new fl"/>
      </div>
      </div>
      </td>
    </tr>
