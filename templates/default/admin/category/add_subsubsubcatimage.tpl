      ...
      <div style="width:34%"> 
         ...
         {if $id neq ""}
                 ...
                 {else}
                  ...
                  {/if}
                 <input type="button" name="Cancel" id="Cancel" value="Cancel" onclick="javascript: window.location = '{$siteroot}/admin/category/subsubsubcatimage.php?cat_id={$smarty.get.cat_id}'" class="but_new fl"/>
      </div>
      </div>
      </td>
    </tr>
