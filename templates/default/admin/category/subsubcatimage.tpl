...
<div class="breadcrumb"><a href="{$siteroot}/admin/index.php">Home</a> &gt; <a href="{$siteroot}/admin/category/category_list.php">Main Categories</a> &gt; <a href="{$siteroot}/admin/category/subcat.php?cat_id={$main_cat_id}">Sub Categories List</a> &gt; Image List</div><br />
...
<!--			<img src="{$siteimg}/icons/add.png" align="absmiddle" /><a href="add_sub_sub_cat_excel.php?cat_id={$smarty.get.cat_id}">Import Sub Sub Categories (.CSV/.XLS file)</a>&nbsp;&nbsp;-->
			...
			<a href="add_subsubcatimage.php?cat_id={$smarty.get.cat_id}">Add Image</a>
		</td>
		<td align="right">
		...
		<form name="frmAction" id="frmAction" method="post" action="">
		  <table cellpadding="6" cellspacing="2" align="center" width="100%" border="0" class="listtable">
			...
			<td width="25%" align="left">Sub Sub Image Title</td>
		  ...
		  <td valign="middle">
		   <div>
                      <img src="{$siteroot}/templates/default/images/icons/application_edit.png" align="absmiddle" />
                        <a href="add_subsubcatimage.php?edit_id={$list[i].id}&cat_id={$smarty.get.cat_id}" title="Edit">
