...
<div class="breadcrumb"><a href="{$siteroot}/admin/index.php">Home</a> &gt; <a href="{$siteroot}/admin/category/category_list.php">Main Categories</a> &gt; <a href="{$siteroot}/admin/category/subcat.php?cat_id={$main_cat_id}">Sub Categories List</a> &gt; <a href="{$siteroot}/admin/category/subsubcat.php?cat_id={$sub_cat_id}">Sub Sub Categories List</a> &gt; Sub Sub Sub Categories List </div><br />
	<table cellpadding="6" cellspacing="2" align="center" width="80%" border="0">
		...
		<td colspan="2"><h3>Sub Category : {$subcatname}</h3></td>
	     ...
	     <tr>
		<td colspan="2"><h3>Sub Sub Category : {$subsubcatname}</h3></td>
	    </tr>-->
	    {$categoryHirarchy}
	    <tr>
		<td colspan="2"><h3>Sub Sub Sub Categories List</h3></td>
	    </tr>
	
	    <tr>
		<td align="left">
			<img src="{$siteimg}/icons/add.png" align="absmiddle" /><a href="add_sub_sub_sub_cat_excel.php?cat_id={$smarty.get.cat_id}">Import Sub Sub Sub Categories (.CSV/.XLS file)</a>&nbsp;&nbsp;
			{*<!--<img align="top" src="{$siteroot}/templates/default/images/icons/excel.gif">&nbsp;<a href="{$siteroot}/admin/category/subsubsubcat.php?cat_id={$smarty.get.cat_id}&view=excel">Deal Sub Sub Sub Categories Report</a>&nbsp;&nbsp;-->*}
			<img src="{$siteroot}/templates/default/images/icons/add.png"  align="absmiddle"/> 
			<a href="add_subsubsubcat.php?cat_id={$smarty.get.cat_id}"> Add Sub Sub Sub Categories</a>
		</td>
		<td align="right">
		...
		<form name="frmAction" id="frmAction" method="post" action="">
		  <table cellpadding="6" cellspacing="2" align="center" width="100%" border="0" class="listtable">
			...
			<td width="25%" align="left">Sub Sub Sub Category Name</td>
			...
			<td valign="top" style="display:none">{$sub_cat[i].category_type|ucfirst} </td>
             		...
             		<td  align="center" valign="top" id="cnt1"><a href="{$siteroot}/admin/category/subsubsubsubcatimage.php?cat_id={$sub_cat[i].id}">Image ({$sub_cat[i].imgTot})</a></td>
			...
			<a href="add_subsubsubcat.php?act=edit&amp;id={$sub_cat[i].id}&cat_id={$smarty.get.cat_id}" class="frmtxt">
			      <strong>Edit</strong>
			  </a>
			</td>
		    </tr>
