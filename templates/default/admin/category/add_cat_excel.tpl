      ...
      <form name="frm" action="" id="frm"  method="post" enctype="multipart/form-data">
        <table width="100%" border="0" cellspacing="2" cellpadding="1">
            ...
            <tr>
                ...
                <td align="left" width="60%"><input name="category_file" type="file" id="category_file"  size="15" class="textbox" contentEditable="false"/><br />Upload .xls / .csv file with maximum 25000 rows only</td>
            </tr>
