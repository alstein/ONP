...
<!--			<img src="{$siteimg}/icons/add.png" align="absmiddle" /><a href="add_sub_sub_sub_cat_excel.php?cat_id={$smarty.get.cat_id}">Import Sub Sub Sub Categories (.CSV/.XLS file)</a>&nbsp;&nbsp;-->
			...
			<a href="add_subsubsubsubcatimage.php?cat_id={$smarty.get.cat_id}">Add Image</a>
		</td>
		<td align="right">
		...
		<form name="frmAction" id="frmAction" method="post" action="">
		  <table cellpadding="6" cellspacing="2" align="center" width="100%" border="0" class="listtable">
			...
			<td width="25%" align="left">Sub Sub Sub Image Title</td>
		  ...
		  <td valign="middle">
		   <div>
                      <img src="{$siteroot}/templates/default/images/icons/application_edit.png" align="absmiddle" />
                        <a href="add_subsubsubsubcatimage.php?edit_id={$list[i].id}&cat_id={$smarty.get.cat_id}" title="Edit">
