...
<div class="breadcrumb"><a href="{$siteroot}/admin/index.php">Home</a> &gt; <a href="{$siteroot}/admin/category/category_list.php">Main Categories</a> &gt; <a href="{$siteroot}/admin/category/subcat.php?cat_id={$smarty.get.cat_id}">Sub Categories List</a> &gt; {if $result.id eq ''}Add{else}Edit{/if} Deal  Subcategory</div><br />
	...
	<input type="hidden" value="{$result.id}" name="subcaatid" id="subcaatid">
        <table width="100%" border="0" cellspacing="2" cellpadding="1">
            ...
            <tr>
                <td></td>
                <td align="left">
              <span id="buttonregister"> <input type="submit" name="Submit" id="Submit" value="Submit"></span>&nbsp; &nbsp; &nbsp;
		      <input type="button" name="Cancel" value="Cancel"  onclick="javascript: location='{$siteroot}/admin/category/subcat.php?cat_id={$smarty.get.cat_id}'" /></td>
            </tr>
	  </table>
      </form>
    </div>
