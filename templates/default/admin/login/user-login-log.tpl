...
{
    var str_url = SITEROOT+"/admin/login/user-login-log.php?sortby="+s_name+"&sorttype="+s_type;
...
<div class="breadcrumb"><a href="{$siteroot}/admin/index.php">Home</a> &gt; Consumer Login List</div><br/>
