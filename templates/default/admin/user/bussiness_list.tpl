...
<div class="holdthisTop">
	...
	<tr>
		<td width="5%" align="right">Zip code:</td>
	...
	{* <!--<td width="5%" align="right">zipcode :</td>
		...
		<td width="10%" align="right">Bussiness name:</td>
		<td width="10%">	
		 <label>
		...
		<td width="10%"  align="right">Telephone no:
		</td><TD>
				<input type="text" id="area_code" name="area_code" value=""  style="width:55px"/>
				<input type="text" id="telephoneno" name="telephoneno" value=""  style="width:90px"/>
			</td>
			<td></td>
			<td></td>
	...
	<tr>
	<td colspan="4" width="5%" align="center"><input type="submit" name="submit1" value="Search"></td>	
	</tr>
	<!--<td width="5%">TO</td>
	<td width="20%">
        {if $edate}
...
<div style="overflow:auto; width:100%; height: 100%;"> 
	...
	<td width="10%"><a href="bussiness_list.php?sortord={if $ord=='asc'}desc{else}asc{/if}&sorttype=telephone&categoryid={$smarty.get.categoryid}&searchuser={$searchuser}" >Telephone No</a></td>
...
<td width="8%"><a href="bussiness_list.php?sortord={if $ord=='asc'}desc{else}asc{/if}&sorttype=comment&categoryid={$smarty.get.categoryid}&searchuser={$searchuser}" >Comment</a></td>
	<td width="3%" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Action&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
  			...
  			<tr class="grayback" id="chk{$smarty.section.i.iteration}">
    				...
    				<td valign="top">
               <img src="{$siteimg}/icons/{if $users[i].approve eq '0'}award_star_silver_1.png{else}award_star_silver_2.png{/if}" align="absmiddle" />
    				{$users[i].name}</td>

                                <td valign="top">{$users[i].business_code}</td>

                                <td valign="top">{$users[i].date_of_approval|@date_format}</td>

    				<td valign="top">{$users[i].category}</td>
	
				<td valign="top">{$users[i].area_code}-{$users[i].phone}</td>
	...
	<td valign="top">{$users[i].comment|@substr:0:40}</td>
				<td align="left">
					<img src="{$siteroot}/templates/default/images/icons/film.png" align="absmiddle" />	
						<a href="bussiness_view.php?business_id={$users[i].business_id}" title="Show User Details"><strong>View</strong></a>
						<br/>
  			...
  			<tr>
				...
				<td align="left" colspan="3"><select name="action" id="action">
					...
					<option value="delete">Delete</option>
				      ...
				      <div><span id="acterr" class="error"></span></div>
            </td>
