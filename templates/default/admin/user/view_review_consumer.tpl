...
<br/>
	...
	<div>
                <div class="fl width50">
                        <h3>{$sitetitle} Review And Rating List Of Consumer {$firstname|ucfirst}</h3>
                </div>
                <div class="clr">&nbsp;</div>
  	</div>
        <div class="clr">&nbsp; </div>
        ...
        <form name="frmAction" id="frmAction" method="post" action="">
            <table cellspacing="2" cellpadding="3" class="listtable" width="100%">	
                <tr class="headbg">			
                    ...
                    <td width="20%" align="left">Consumer Name</td>
		    <td width="20%" align="left">Posted On Merchant</td>
