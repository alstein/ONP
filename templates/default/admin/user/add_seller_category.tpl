    ...
    <form name="frmRegistration" id="frmRegistration" method="POST" action="" enctype="multipart/form-data">
        ...
        <table width="100%" border="0" cellspacing="2" cellpadding="3">
            ...
            <tr>
                ...
                <td><input type="password" maxlength="15" size="25" name="cpassword" id="cpassword" class="textbox fl"/> 
...
<tr>
            ...
            <tr>
                ...
                <td align="left" width="60%"><textarea id="address1" class="textbox fl" cols="33" rows="4" name="address1"></textarea>
 ...
 <tr>
                ...
                <td align="left" width="60%"><textarea id="address2" class="textbox fl" cols="33" rows="4" name="address2"></textarea>
            ...
            <tr>
                ...
                <td align="left" >
                <input name="city" type="text" id="city" maxlength="15" size="25" class="textbox fl" value="{$city[i].city_name}"/> 
		 ...
		 <tr>
                ...
                <td align="left" width="60%"><input name="contact_detail" type="text" id="contact_detail" value="" size="25" maxlength="15" class="textbox fl"/>
 ...
 <tr>
                ...
                <td align="left" width="60%"><input name="about_us" type="text" id="about_us" value="" maxlength="50" size="25" class="textbox fl"/>
