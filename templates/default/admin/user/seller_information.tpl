...
<div class="holdthisTop">
    ...
    <form name="frmRegistration" id="frmRegistration" method="POST" action="" enctype="multipart/form-data">
		...
		<tr>
			<td align="right" valign="top"><span style="color:red">*</span> Business Name:</td>
			<td><input type="text" maxlength="70" size="25" value="{$user.business_name}" name="business_name" id="business_name" class="textbox fl" />
					<a class="tooltip_css fl" href="javascript:void(0);">
								<span class="classic_css">{tooltip label_id=61}</span>
					</a>
					<div class="clr"></div>
...
<tr>
			...
			<td><input type="text" maxlength="70" size="25" name="contact_person" id="contact_person" class="textbox fl" value="{$user.contact_person}"/>
  ...
  <tr><td></td>
	<td>
              ...
              <div class="fl">
		<input type="checkbox" name="chk_outlet" id="chk_outlet" value="yes" {if $user.address2 neq ''} checked="true" {/if} onclick="javascript:show_address();" >
		...
		<input name="address1" id="address1" type="text" class="textbox fl" value="{$user.address1}" />
 ...
 <tr id="div_address1" style="display:none;">
                ...
                <td align="left" width="60%"><input name="address2" id="address2" type="text" class="textbox fl" value="{$user.address2}" />
		...
		<tr id="div_address2" style="display:none;">
                ...
                <td align="left" width="60%"><input name="address3" id="address3" type="text" class="textbox fl" value="{$user.address3}" />
		...
		<tr id="div_address3" style="display:none;">
                ...
                <td align="left" width="60%"><input name="address4" id="address4" type="text" class="textbox fl" value="{$user.address4}" />
	...
	<tr id="div_address4" style="display:none;">
                ...
                <td align="left" width="60%"><input name="address5" id="address5" type="text" class="textbox fl" value="{$user.address5}" />
...
<tr>
                ...
                <td align="left" width="60%"><textarea name="about_us" id="about_us" rows="5" cols="25" class="textbox fl valid">{if $user.about_us neq ''}{$user.about_us}{else} {/if}</textarea>
...
<input name="upload_photo" type="file" id="upload_photo" value="" size="22"/><br>
