...
<a href="{$siteroot}/admin/city/city_list.php?stateid={$state.id}&countryid={$country.countryid}">City/Town</a> &gt; Import City/Town
</div>
<br />
...
<div class="holdthisTop">
    <div>
		<div class="fl width50">
			<h3>{$sitetitle} Import City/Town (using .csv/.xls)</h3><br>
    ...
    <div id="UserListDiv" name="UserListDiv" >
      <form name="frm" action="" id="frm"  method="post" enctype="multipart/form-data">
        <table width="100%" border="0" cellspacing="2" cellpadding="1">
            <tr>
                <td colspan="2" align="right"><a href="{$siteroot}/admin/city/city_list.php?stateid={$state.id}&contryid={$country.countryid}">Back</a></td>
            </tr>
            <tr>
	...
	<div class="fr"><h3><a href="{$siteroot}/admin/city/add_excel.php?view=test_excel">Download Sample .csv file</a></h3></div>

	<table border="1" width="100%" style="margin-top:10px;">
		<tr><th width="20%">City/Town Name</th><th></th><th></th><th></th><th></th></tr>
		<tr><td>Bath</td><td></td><td></td><td></td><td></td></tr>
		<tr><td>Bradley Stoke</td><td></td><td></td><td></td><td></td></tr>
		<tr><td>Bristol</td><td></td><td></td><td></td><td></td></tr>
		<tr><td>Chew Magna</td><td></td><td></td><td></td><td></td></tr>
	</table>
</div>
{include file=$footer}