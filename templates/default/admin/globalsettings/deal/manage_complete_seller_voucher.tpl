...
function showBySeller()
{
    ...
    if(dealtype == "gbi")
    {
        ...
        window.location = SITEROOT+"/admin/globalsettings/deal/manage_complete_seller_voucher.php?"+query;
        return;
    }
    else if(sellerid != "")
    {
    ...
    {
        window.location = SITEROOT+"/admin/globalsettings/deal/manage_complete_seller_voucher.php";
        return;
    }
}
...
<h3 align="left"><b>Manage Completed Seller Voucher</b></h3>
...
<table cellpadding="2" cellspacing="2" border="0" width="82%">
  <tr>
	...
	<table width="100%" align="right" cellpadding="0" cellspacing="0">
		...
		<img align="absmiddle" src="{$siteroot}/templates/default/images/icons/excel.gif">&nbsp;<a style="margin-right:100px;" href="{$siteroot}/admin/globalsettings/deal/manage_complete_seller_voucher.php?view=excel&dealstatus={$smarty.get.dealstatus}&seller_id={$smarty.get.seller_id}"><strong>Deal Report</strong></a>
...
<!--             <td width="15%" align="center" valign="top">User</td> -->
	    ...
	    <td align="center" valign="top">
                ...
                <strong>Feedback</strong></a> {if $deal[i].deal_unique_id|@in_array:$autho}| 
                        <img src="{$siteroot}/templates/default/images/icons/film.png" align="absmiddle" /><a target="_blank" href="{$siteroot_https}/admin/globalsettings/deal/get_autho_release.php?id={$deal[i].deal_unique_id}"><strong>Release</strong></a>
                        {/if}
			<img align="top" src="{$siteroot}/templates/default/images/icons/excel.gif">&nbsp;<a href="{$siteroot}/admin/globalsettings/deal/manage_complete_seller_voucher.php?view=excel&exel_id={$deal[i].deal_unique_id}&dealstatus={$smarty.get.dealstatus}"><strong>Deal Report</strong></a>
	    </td>
          </tr>
          {sectionelse}
          <tr>
