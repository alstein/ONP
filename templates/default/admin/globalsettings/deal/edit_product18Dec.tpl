	  ...
	  <td colspan="2">
	    <div id="show2" style="display:block">
	      <table width="70%" cellspacing="5" cellpadding="5">
		    ...
		    <tr>
			<td align="right" valign="top"><span class="red">*</span> Main Category: </td>
		    ...
		    <tr>
			<td align="right" valign="top"><span class="red">*</span> Sub Category: </td>
			<td colspan="2" align="left">
			    <div id="replace">
		    ...
		    <tr>
		      <td align="right" valign="top"> Video Link: </td>
		  ...
		  <tr>
			  ...
			  <table>
			      ...
			      {/section}
                    ...
                    <tr>
                        <td align="right" valign="top"><strong>Estimated Final Value Fee &pound;: </strong></td>
                        <td colspan="2" align="left"><span id="span3">{if $deal_info.final_value}{$deal_info.final_value}{else}xxxxx{/if}</span></td>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
                        <td colspan="2"><input type="submit" value="Save" name="Submit"/> <input type="button" value="Cancel" onclick="javascript: location='manage_deal.php';"/> </td>
                    </tr>	
	      </table>
	    </div>
	  </td>
