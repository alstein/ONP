...
{
    var str_url = SITEROOT+"/admin/globalsettings/deal/expired_deal.php?sortby="+s_name+"&sorttype="+s_type;
...
<!--<div class="breadcrumb">--><p class="breadcrumb"><a href="{$siteroot}/admin/index.php">Home</a> &gt; Manage Completed Deals</p>
</div><br/>
	  ...
	  <tr>
		...
		<table cellpadding="6" cellspacing="2" border="0" width="100%" class="listtable">
			<tr class="headbg">
				...
				<td width="13%" align="left" valign="top"><a href="javascript:void(0)" onclick="sort_all('deal_title',document.getElementById('sorttype_title').value);">Deal Name</a><input type="hidden" name="sorttype_title" id="sorttype_title" value="{if $sorttype_title}{$sorttype_title}{else}ASC{/if}"/></td>
				<td width="10%" align="left" valign="top"><a href="javascript:void(0)" onclick="sort_all('fullname',document.getElementById('sorttype_seller').value);">Merchant Name</a><input type="hidden" name="sorttype_seller" id="sorttype_seller" value="{if $sorttype_seller}{$sorttype_seller}{else}ASC{/if}"/></td>
				...
				<td width="8%" align="left" valign="top"><a href="javascript:void(0)" onclick="sort_all('	deal_category',document.getElementById('sorttype_category').value);">Deal Type</a><input type="hidden" name="sorttype_category" id="sorttype_category" value="{if $sorttype_category}{$sorttype_category}{else}ASC{/if}"/></td>
...
<a href="javascript:void(0)"> Number Of Bought</a>
				...
				<td width="36%" align="left" valign="top">Action</td>
			</tr>
		{section name=i loop=$deal}
			
			{if $deal[i].deal_count ge  $deal[i].max_deal_no}
			<tr class="grayback" id="tr_{$deal[i].deal_unique_id}">
				<td rowspan="2" align="center" valign="top">
					<input type="checkbox" name="deal_id[]" id="deal_id" value="{$deal[i].deal_unique_id}" />
				</td>
