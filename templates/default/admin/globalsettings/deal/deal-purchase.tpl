...
<div class="holdthisTop">
  <h3 class="fl width50">Manage Deal Purchase Order</h3>
  ...
  <table width="100%"  align="center" cellpadding="2" cellspacing="2" border="0">
	...
	<table width="100%"  border="0" cellpadding="10" cellspacing="2" class="listtable">
	    <tr class="headbg">
		 ...
		 <td width="10%" align="center" valign="top">Transaction Id</td>	
	      <td width="10%" align="center" valign="top">Voucher Code</td>	
	      <td width="10%" align="center" valign="top">Dispatched</td>	 
	  </tr>
	  {section name=i loop=$product}
		...
		<td align="center" valign="top" >{$product[i].transaction_id}</td>
	      <td align="center" valign="top" >{if $product[i].deal_type eq 'product'}---{else}{$product[i].pay_unique_id}{/if}</td>
	      <td align="center" valign="top" >{$product[i].charge_date|date_format}</td>			
	     </tr>
            {/if}
	  {sectionelse}
