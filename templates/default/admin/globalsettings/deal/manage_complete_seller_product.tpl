...
<h3 align="left"><b>Manage Completed Seller Product</b></h3>
...
<img align="absmiddle" src="{$siteroot}/templates/default/images/icons/excel.gif">&nbsp;<a style="margin-right:100px;" href="{$siteroot}/admin/globalsettings/deal/manage_complete_seller_product.php?view=excel&dealstatus={$smarty.get.dealstatus}&seller_id={$smarty.get.seller_id}"><strong>Deal Report</strong></a>
		<strong> Deal Status: </strong>
            ...
            <input type="hidden" name="dealtype" id="dealtype" value="product" />
...
<!--             <td width="15%" align="center" valign="top">User</td> -->
	    ...
	    <td align="center" valign="top">
                ...
                <strong>Feedback</strong></a> {if $deal[i].deal_unique_id|@in_array:$autho}| 
                        <img src="{$siteroot_https}/templates/default/images/icons/film.png" align="absmiddle" /><a target="_blank" href="{$siteroot}/admin/globalsettings/deal/get_autho_release.php?id={$deal[i].deal_unique_id}"><strong>Release</strong></a>
                        {/if}
		<img align="top" src="{$siteroot}/templates/default/images/icons/excel.gif">&nbsp;<a href="{$siteroot}/admin/globalsettings/deal/manage_complete_seller_product.php?view=excel&exel_id={$deal[i].deal_unique_id}&dealstatus={$smarty.get.dealstatus}"><strong>Deal Report</strong></a>
	    </td>
          </tr>
          {sectionelse}
          <tr>
