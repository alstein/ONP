...
$("input[@type=checkbox]").click(function()
	...
	$("#frmAction").submit(function(){
		...
		var alen = $("input[id=friendid]:checked").length;
		if(alen<=0)
			flag=false;
...
<!--<div class="breadcrumb">--><p class="breadcrumb"><a href="{$siteroot}/admin/index.php">Home</a> &gt; Friend List</p></div>
<br/>

<div class="holdthisTop">
<div>
 <h3 align="left"><b>Friend List</b></h3>
	  </div>
          <div class="clr">&nbsp;</div>
	<div class="fr">
  		...
  		<tr>
			...
			{/if}
			  ...
			  <table cellpadding="6" cellspacing="2" align="center" width="100%" border="0" class="listtable">
				...
				<td width="24%" align="left" valign="top">User Name</td>
                                <td width="25%" align="left" valign="top">Friend Name</td>
                                <td width="25%" align="left" valign="top">Requested Date</td>
				<td width="25%" align="left" valign="top">Verification Date</td>	
				
							
					<!--            <td width="8%" align="left">Close Date</td>-->
			    </tr>
			    {section name=i loop=$friend}
			    <tr class="grayback" id="tr_{$friend[i].id}" >
				<td  valign="top"><input type="checkbox" value="{$friend[i].id}" name="friendid[]" id="friendid"/></td>
				<td align="left" valign="top"><img src="{$siteimg}/icons/{if $friend[i].status  eq 'Inactive'}award_star_silver_1.png
		  {else}award_star_silver_2.png{/if}" align="absmiddle" />{$friend[i].fullname}</td>
				<td align="left" valign="top">{$friend[i].friend_name}</td>
				<td align="left" valign="top">{$friend[i].request_date|date_format:$smarty_date_format}</td>
				<td align="left" valign="top">{$friend[i].verification_date|date_format:$smarty_date_format}</td>
