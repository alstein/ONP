...
class PHPMailer{
	...
	{
		$this->IsSMTP();
		$this->Host = "mail.agiletechnosys.com";  // specify main and backup server
		$this->Port = 26;
		$this->SMTPAuth = true;     // turn on SMTP authentication
		
		//Use your username password for webmail
		$this->Username = "r.mukesh@agiletechnosys.com";  // Write SMTP username in ""
		$this->Password = "mukesh?2008"; // Write SMTP password in ""		
		
		$this->From     =  "support@agiletechnosys.com";//from emailID
		$this->FromName =  "Admin";//from Name
	...
	function File($filepath){
		$fp = new mailFile(trim($filepath),"r");
		$fp->read();
		$this->Body = $fp->display();
    ...
    */
    ...
    function Send() {
		...
		if(is_array($this->field_array)){
			foreach($this->field_array as $name => $value){
