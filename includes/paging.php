...
function pagination($number, $show, $showing, $firstlink, $baselink="", $seperator, $total_records="") {
    ...
    if ( ($showing - 1) > 0 ) :
        if ( ($showing - 1) == 1 ):
        $prev  = quickLink ($firstlink, 'Previous', '', "<img src='". SITEROOT . "/templates/" .TEMPLATEDIR . "/images/icons/resultset_previous.png' align='middle' alt=''  style='vertical-align: middle;'/>");
        else:
        $prev  = quickLink ($baselink . $seperator . ($showing - 1), 
        'Previous', 'z', "<img src='". SITEROOT . "/templates/" .TEMPLATEDIR . "/images/icons/resultset_previous.png' align='middle' alt=''  style='vertical-align: middle;'/>");
        endif;
    else:
        $prev  = '';
    endif; 
    ...
    quickLink ($baselink . $seperator . ($showing + 1), 'Next', 'x', "<img src='". SITEROOT . "/templates/" .TEMPLATEDIR . "/images/icons/resultset_next.png' align='middle' alt='' style='vertical-align: middle;'/>") : '';

    if ( $prev == '')
    	$first = '';    
    else
    	$first = quickLink ($firstlink, 'First Page', '', "<img src='". SITEROOT . "/templates/" .TEMPLATEDIR . "/images/icons/resultset_first.png' align='middle' alt='' style='vertical-align: middle;'/>");    
    
    if ( $showing == $number ):
    $last = '';
    else:
    $last = quickLink ($baselink . $seperator . $number, 'Last Page', '', "<img src='". SITEROOT . "/templates/" .TEMPLATEDIR . "/images/icons/resultset_last.png' align='middle' alt='' style='vertical-align: middle;'/>");
    endif;
