...
if (!defined('__CLASS_HTML2PDF__'))
{
	...
	// pour voir le temps et la m�moire utilis�s pour la conversion :
	...
	class HTML2PDF
	{
		...
		var $format			= 'A3';		// format de la page : A4, A3, ...
...
*/
		...
		*/
		function Output($nom_fichier = 'document.pdf', $return = false)
		{
			if ($return)
			{
				return $this->pdf->Output($nom_fichier, 'F');
			}
			else
			{
				$this->pdf->Output($nom_fichier, 'F');
				return true;
			}
		}
