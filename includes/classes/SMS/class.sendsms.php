...
class SendSMS
{
	private $url = 'http://www.textmarketer.biz/services/rest/sms'; // url of the service
	private $username = '7633X699'; //'myAPIusername'; // CHANGE THIS!!!
	private $password = '43948'; //'myAPIpassword'; // CHANGE THIS!!
